...
<!-- Mirrored from pelegrinodev.com/mightyadmin/index.php by HTTrack Website Copier/3.x [XR&CO'2008], Sat, 16 Feb 2013 19:37:03 GMT -->
<head>
        <meta charset="UTF-8" />
        ...
        <link rel="stylesheet" href="/assets/cp/default/plugins/elrte/css/elrte.min.css" />
        <link rel="stylesheet" href="/assets/cp/default/plugins/miniColors/jquery.miniColors.css" />
        <link rel="stylesheet" href="/assets/cp/default/plugins/fullCalendar/fullcalendar.css" />
        <link rel="stylesheet" href="/assets/cp/default/plugins/elfinder/css/elfinder.css" />
        ...
        <script src="/assets/cp/default/js/demo.js"></script>
        ...
        <script src="/assets/cp/default/plugins/ui/ui.spinner.min.js"></script>
        <script src="/assets/cp/default/plugins/datables/jquery.dataTables.min.js"></script>
        <script src="/assets/cp/default/plugins/jquery.metadata.js"></script>
        <script src="/assets/cp/default/plugins/progressbar.js"></script>
        ...
        <script src="/assets/cp/default/plugins/elrte/elrte.min.js"></script>
        <script src="/assets/cp/default/plugins/miniColors/jquery.miniColors.min.js"></script>
        <script src="/assets/cp/default/plugins/fullCalendar/fullcalendar.min.js"></script>
        <script src="/assets/cp/default/plugins/elfinder/elfinder.min.js"></script>
    </head>
    <body class="fixed fixed-topbar"><!-- .fixed or .fluid -->
		<div class="single">
			<div id="logo">
				<img src="/assets/cp/default/images/logo.png" alt="logo" />
			</div>
			<section id="content">
				<div class="box">
					<form action="/admin/login" method="post" class="validate-engine">
						<label>
							<i class="fugue-user"></i>
							<input type="text" name="username" data-validation-engine="validate[required]" 
									id="login" placeholder="Login" autofocus />
						</label>
...
<!-- Mirrored from pelegrinodev.com/mightyadmin/login.php by HTTrack Website Copier/3.x [XR&CO'2008], Sat, 16 Feb 2013 19:38:39 GMT -->
</html>
